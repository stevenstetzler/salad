...
from ..catalog.catalog import DetectionCatalog, MultiEpochDetectionCatalog
...
def main():
    ...
    t1 = time()
    single_epoch_catalogs = Parallel(n_jobs=args.processes)(delayed(detect)(images[key], threshold=args.threshold, no_masks=args.no_masks) for key in images)
