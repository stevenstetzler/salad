import logging
import sys
from ..io.serialize import Serializable, read, write
...
def main():
    ...
    images = {(ref.dataId.get('visit', ref.dataId.get('exposure')), ref.dataId.get("detector")) : Image(args.datasetType, butler.getURI(ref).ospath) for ref in refs}
