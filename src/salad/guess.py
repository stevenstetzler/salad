...
def main():
    ...
    X = catalog.X(columns=[args.ra_column, args.dec_column, args.time_column], sky_units=sky_units, time_units=time_units)
    ...
    projection = project(X, directions.b.value, args.reference_time)
    projection.write(args.output)
